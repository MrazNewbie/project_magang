                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="pouch" {{ $data->type === 'pouch' ? 'selected' : '' }}>Pouch</option>
                                <option value="kalender" {{ $data->type === 'kalender' ? 'selected' : '' }}>Kalender
                                </option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="Besar" {{ $data->kategory === 'Besar' ? 'selected' : '' }}>Besar
                                </option>
                                <option value="sedang" {{ $data->kategory === 'sedang' ? 'selected' : '' }}>Sedang
                                </option>
                                <option value="kecil" {{ $data->kategory === 'kecil' ? 'selected' : '' }}>
                                    Kecil</option>
                            </select>
                        </div>
                    </div>
